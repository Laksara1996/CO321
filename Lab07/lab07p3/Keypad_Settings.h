...
//PORT, PIN
#define Keypad_R0			B, 5
#define Keypad_R1			B, 4
#define Keypad_R2			B, 3
#define Keypad_R3			B, 2
#define Keypad_C0			B, 1
#define Keypad_C1			B, 0
#define Keypad_C2			D, 7
#define Keypad_C3			D, 6
//----------------------------------------------//
#endif